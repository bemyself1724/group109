...
设 ck_{i,j}  为 CK_i 的第j字节 $(i=0 ,1, \cdots  31; j=0, 1, 2, 3)$, 即 $CK_i−(ck_{i,0}, ck_{i,1}, ck_{i,2}, ck_{i,3}) \in (Z^{8}_2)^4$ ,$ck_{i,j}− (4i + j) \times  7(\ mod \ 256)$ 。其中固定参数 $CK_i(i= 0, 1,\cdots 31)$
​		
#### **3.** 加密过程
...
$B-(b_0, b_1, b_2, b_3) ⊕ (Z^{32}_2)^4 $, 则$(b_0, b_1, b_2, b_3) -τ(A)-(Sbox(a_0),Sbox(a_1),Sbox(a_2),Sbox(a_3))$
